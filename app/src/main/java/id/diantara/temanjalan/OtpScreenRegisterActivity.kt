...
import kotlinx.android.synthetic.main.activity_otp_register_screen.*
import java.util.concurrent.TimeUnit

class OtpScreenRegisterActivity : Activity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        phoneNum = "+62" + intent.getStringExtra("phoneNum").toString()
