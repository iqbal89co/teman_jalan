...
import kotlinx.android.synthetic.main.activity_otp_login_screen.*
import java.util.concurrent.TimeUnit

class OtpScreenLoginActivity : Activity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        var phoneNum = "+62" + intent.getStringExtra("phoneNum").toString()
